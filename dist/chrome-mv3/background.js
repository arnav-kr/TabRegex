var background = function() {
  ...
  var RequestType = /* @__PURE__ */ ((RequestType2) => {
    RequestType2[RequestType2["QUERY_TABS"] = 0] = "QUERY_TABS";
    RequestType2[RequestType2["CLOSE_TABS"] = 1] = "CLOSE_TABS";
    return RequestType2;
  })(RequestType || {});
  background;
  const definition = defineBackground(() => {
    ...
    browser.runtime.onMessage.addListener(
      async (request, _, sendResponse) => {
        if (request.type === RequestType.QUERY_TABS) {
          let tabs = await browser.tabs.query({});
          return tabs;
        }
        if (request.type === RequestType.CLOSE_TABS) {
          let ids = request.tabs;
